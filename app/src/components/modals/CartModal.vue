...
<template>
  <transition name="fade">
    ...
    >
      <div class="bg-white shadow-lg max-w-md w-full h-full p-9 relative flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto mb-4">
          ...
          <div v-if="cartItems.length > 0" class="border-t pt-4 bg-white">
            ...
            <div class="flex justify-center items-center">
              <button
                ...
                class="bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition duration-200 font-semibold w-full"
              >
